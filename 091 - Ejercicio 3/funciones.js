function validar(formulario) {
  ...
  if((formulario.dia.options[formulario.dia.selselectedIndex].value == 0) || (formulario.mes.options[formulario.mes.selectedIndex].value == 0) || (formulario.anio.options[formulario.anio.selectedIndex].value == 0)) {
